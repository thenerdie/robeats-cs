...
local admins = {}
local mods = {}
for i, v in pairs(script.Devs:GetChildren()) do
	table.insert(devs, #devs+1, v.Name)
--	print("test")
end
for i, v in pairs(script.Admins:GetChildren()) do
	table.insert(admins, #admins+1, v.Name)
--	print("test")
end
for i, v in pairs(script.Mods:GetChildren()) do
	table.insert(mods, #mods+1, v.Name)
--	print("test")
end
